export const vocab = {
  ...
  words: [
    ...
    { word: "urbanization", translation: "urbanisation", example: "Rapid urbanization has transformed previously rural areas into metropolitan regions." },
    { word: "urban sprawl", translation: "étalement urbain", example: "Urban sprawl increases car dependency and infrastructure costs." },
    ...
    { word: "gentrification", translation: "gentrification", example: "Gentrification often displaces long-term residents as property values rise." },
    ...
    { word: "urban planning", translation: "urbanisme", example: "Urban planning coordinates land use, infrastructure, and social services." },
    { word: "spatial planning", translation: "aménagement du territoire", example: "Spatial planning addresses development across different geographic scales." },
    ...
    { word: "strategic planning", translation: "planification stratégique", example: "Strategic planning identifies long-term development priorities and implementation steps." },
    ...
    { word: "sustainable architecture", translation: "architecture durable", example: "Sustainable architecture minimizes environmental impact through efficient resource use." },
    { word: "green building", translation: "bâtiment écologique", example: "The green building features solar panels and rainwater collection systems." },
    ...
    { word: "housing affordability", translation: "accessibilité au logement", example: "Housing affordability has decreased in many global cities." },
    { word: "homelessness", translation: "sans-abrisme", example: "The city implemented new programs to address rising homelessness." },
    ...
    { word: "affordable housing", translation: "logement abordable", example: "The development includes 30% affordable housing units." },
    ...
    { word: "urban heat island", translation: "îlot de chaleur urbain", example: "The urban heat island effect makes city centers significantly warmer than surrounding areas." },
    { word: "air pollution", translation: "pollution atmosphérique", example: "Vehicle emissions contribute significantly to urban air pollution." },
    { word: "noise pollution", translation: "pollution sonore", example: "Noise pollution affects residents' health and quality of life." },
    { word: "waste management", translation: "gestion des déchets", example: "Effective waste management systems are essential for public health in cities." },
    ...
    { word: "social exclusion", translation: "exclusion sociale", example: "Urban design can either mitigate or exacerbate social exclusion." },
    ...
    { word: "pedestrian zone", translation: "zone piétonne", example: "The pedestrian zone transformed the shopping district into a vibrant public space." },
    ...
    { word: "IoT (Internet of Things)", translation: "IdO (Internet des Objets)", example: "IoT sensors monitor air quality throughout the smart city." },
    ...
    { word: "smart grid", translation: "réseau intelligent", example: "The smart grid optimizes electricity distribution in real-time." },
    ...
    { word: "public housing", translation: "logement public", example: "Public housing is owned and managed by government authorities." },
    { word: "affordable housing", translation: "logement abordable", example: "Affordable housing costs no more than 30% of household income." },
    ...
    { word: "real estate market", translation: "marché immobilier", example: "The competitive real estate market makes homeownership difficult for many." },
    ...
    { word: "housing shortage", translation: "pénurie de logements", example: "The housing shortage has driven up rents throughout the region." },
    ...
    { word: "rent control", translation: "contrôle des loyers", example: "Rent control limits how much landlords can increase rents annually." },
    ...
    { word: "gentrification", translation: "gentrification", example: "Gentrification raises concerns about displacement of long-term residents." },
    ...
    { word: "community engagement", translation: "engagement communautaire", example: "Effective community engagement ensures diverse voices shape development decisions." },
