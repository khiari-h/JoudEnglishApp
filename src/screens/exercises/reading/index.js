...
import ExerciseFeedback from "../../../../exercise-common/ExerciseFeedback";
import NavigationButtons from "../../../../exercise-common/NavigationButtons";
import InstructionBox from "../../../../exercise-common/InstructionBox";
...
// Utils
import { getReadingData, getLevelColor } from "../../../utils/reading/readingHelper";
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.progressContainer}>
        <ProgressBar
          ...
          valueFormatter={(value, total) => `${completedQuestions[selectedExerciseIndex]?.length || 0}/${total}`}
          height={6}
      ...
      <View style={styles.navigationContainer}>
        {!showFeedback ? (
          ...
          <NavigationButtons
            ...
            buttonLabels={{
              previous: "Previous",
              next: currentQuestionIndex < currentExercise.questions.length - 1 ? "Next Question" : "Complete",
              skip: "Skip",
              finish: "Finish",
            }}
            variant="standard"
