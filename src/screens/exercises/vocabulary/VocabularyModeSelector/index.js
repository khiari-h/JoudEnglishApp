      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.noteContainer}>
          ...
          <Text style={styles.noteText}>
            <Text style={styles.noteBold}>Conseil :</Text> Le mode Fast est
            idéal pour acquérir rapidement les bases, tandis que le mode
            Classique offre une progression plus détaillée.
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
