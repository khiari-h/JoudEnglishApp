export const vocab = {
  ...
  words: [
    ...
    { word: "modernism", translation: "modernisme", example: "Modernism rejected traditional forms and emphasized experimentation and abstraction." },
    ...
    { word: "avant-garde", translation: "avant-garde", example: "The avant-garde artists pushed boundaries and challenged conventional artistic norms." },
    { word: "impressionism", translation: "impressionnisme", example: "Impressionism captured momentary effects of light and movement in everyday scenes." },
    { word: "expressionism", translation: "expressionnisme", example: "Expressionism conveyed emotion and subjective experience rather than objective reality." },
    { word: "cubism", translation: "cubisme", example: "Cubism fragmented objects into geometric forms viewed from multiple perspectives." },
    { word: "surrealism", translation: "surréalisme", example: "Surrealism explored the realm of dreams and the unconscious mind." },
    ...
    { word: "minimalism", translation: "minimalisme", example: "Minimalism reduced art to essential elements, often using geometric forms." },
    { word: "conceptual art", translation: "art conceptuel", example: "Conceptual art prioritizes ideas over aesthetic and material concerns." },
    { word: "performance art", translation: "art performance", example: "Performance art uses the artist's body as the medium in live presentations." },
    { word: "installation art", translation: "art d'installation", example: "Installation art creates immersive, site-specific experiences for viewers." },
    { word: "digital art", translation: "art numérique", example: "Digital art uses technology as the primary creative tool and medium." },
    { word: "contemporary art", translation: "art contemporain", example: "Contemporary art reflects current social, political, and cultural contexts." },
    ...
    { word: "realism", translation: "réalisme", example: "Realism depicted ordinary people and situations with unembellished accuracy." },
    
    // Analyse esthétique
    { word: "aesthetics", translation: "esthétique", example: "Aesthetics is the philosophical study of beauty and artistic experience." },
    { word: "composition", translation: "composition", example: "The painting's composition uses diagonal lines to create dynamic movement." },
    { word: "form", translation: "forme", example: "The sculpture's form harmoniously balances solid mass and empty space." },
    { word: "texture", translation: "texture", example: "The artist used impasto technique to create rich texture on the canvas." },
    { word: "perspective", translation: "perspective", example: "Linear perspective creates the illusion of depth on a flat surface." },
    ...
    { word: "proportion", translation: "proportion", example: "The Renaissance emphasized ideal proportions based on mathematical ratios." },
    { word: "balance", translation: "équilibre", example: "The composition achieves balance through careful arrangement of visual elements." },
    ...
    { word: "focal point", translation: "point focal", example: "The bright red element serves as the focal point that draws the viewer's attention." },
    ...
    { word: "medium", translation: "médium", example: "The artist's chosen medium of watercolor creates translucent, luminous effects." },
    { word: "technique", translation: "technique", example: "The pointillist technique builds images through small, distinct dots of color." },
    ...
    { word: "artistic expression", translation: "expression artistique", example: "Artistic expression communicates ideas and emotions through sensory experiences." },
    ...
    { word: "patronage", translation: "mécénat", example: "Renaissance art flourished under the patronage of wealthy families like the Medicis." },
    { word: "commission", translation: "commande", example: "The mural was created on commission from the city government." },
    ...
    { word: "site-specific", translation: "spécifique au site", example: "The site-specific installation responded to the architectural features of the space." },
    ...
    { word: "creative industries", translation: "industries créatives", example: "Creative industries generate cultural goods and services with economic and social value." },
    ...
    { word: "art market", translation: "marché de l'art", example: "The art market determines the commercial value of artistic works." },
    { word: "gallery", translation: "galerie", example: "The gallery represents emerging artists and connects them with collectors." },
    ...
    { word: "art fair", translation: "foire d'art", example: "International art fairs attract dealers, collectors, and art enthusiasts from around the world." },
    ...
    { word: "intellectual property", translation: "propriété intellectuelle", example: "Copyright laws protect artists' intellectual property from unauthorized use." },
    { word: "creative economy", translation: "économie créative", example: "The creative economy encompasses industries based on individual creativity and talent." },
    ...
    { word: "arts funding", translation: "financement des arts", example: "Government arts funding helps maintain cultural institutions and supports artists." },
    { word: "cultural heritage", translation: "patrimoine culturel", example: "UNESCO designates sites of outstanding cultural heritage for protection." },
    ...
    { word: "cultural diplomacy", translation: "diplomatie culturelle", example: "Cultural diplomacy fosters international understanding through artistic exchange." },
    ...
    { word: "cultural diversity", translation: "diversité culturelle", example: "UNESCO recognizes cultural diversity as a shared heritage of humanity." },
    ...
    // Art contemporain
    { word: "contemporary art", translation: "art contemporain", example: "Contemporary art reflects current issues and embraces diverse forms and media." },
    ...
    { word: "multimedia", translation: "multimédia", example: "The multimedia installation combined video projections, sound, and sculptural elements." },
    { word: "new media art", translation: "art des nouveaux médias", example: "New media art explores creative possibilities of digital and electronic technologies." },
    ...
    { word: "representation", translation: "représentation", example: "Theories of representation examine how images construct meaning and identity." }
  ]
};