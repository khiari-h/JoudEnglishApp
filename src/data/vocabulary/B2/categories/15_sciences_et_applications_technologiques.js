export const vocab = {
  ...
  words: [
    ...
    { word: "research and development", translation: "recherche et développement", example: "Research and development departments convert scientific knowledge into practical applications." },
    { word: "prototype", translation: "prototype", example: "The prototype demonstrated the technology's potential to investors." },
    ...
    { word: "knowledge integration", translation: "intégration des connaissances", example: "Knowledge integration combines insights from disparate fields to solve problems." },
    { word: "multidisciplinary team", translation: "équipe multidisciplinaire", example: "The multidisciplinary team included physicists, biologists, and computer scientists." },
    { word: "transdisciplinary", translation: "transdisciplinaire", example: "Transdisciplinary research creates new conceptual frameworks beyond existing disciplines." },
    { word: "boundary crossing", translation: "franchissement des frontières", example: "Boundary crossing between disciplines often leads to innovation." },
    { word: "synergy", translation: "synergie", example: "The collaboration created synergy between computational and experimental approaches." },
    
    // Science & société
    { word: "science and society", translation: "science et société", example: "The relationship between science and society shapes research priorities and applications." },
    ...
    { word: "technological impact", translation: "impact technologique", example: "Assessing technological impact helps anticipate societal consequences." },
    { word: "science diplomacy", translation: "diplomatie scientifique", example: "Science diplomacy uses scientific collaboration to build international relationships." },
    
    // Vulgarisation scientifique
    { word: "science outreach", translation: "vulgarisation scientifique", example: "Science outreach activities make research accessible to the general public." },
    { word: "popular science", translation: "science populaire", example: "Popular science books explain complex theories in understandable language." },
    { word: "science journalism", translation: "journalisme scientifique", example: "Science journalism reports research findings for non-specialist audiences." },
    { word: "public understanding", translation: "compréhension publique", example: "Public understanding of science supports informed civic participation." },
    { word: "accessible explanation", translation: "explication accessible", example: "An accessible explanation avoids jargon while maintaining accuracy." },
    { word: "science education", translation: "éducation scientifique", example: "Science education develops critical thinking and analytical skills." },
    { word: "science festival", translation: "festival scientifique", example: "The science festival attracted thousands of visitors to interactive exhibits." },
    { word: "scientific visualization", translation: "visualisation scientifique", example: "Scientific visualization transforms complex data into comprehensible images." },
    { word: "science museum", translation: "musée scientifique", example: "Science museums engage visitors through interactive demonstrations." },
