export const vocab = {
  ...
  words: [
    ...
    { word: "regulatory authority", translation: "autorité réglementaire", example: "The legislation delegates regulatory authority to the environmental agency." },
    ...
    { word: "policy evaluation", translation: "évaluation des politiques", example: "Policy evaluation helps determine whether programs achieve intended outcomes." },
    ...
    { word: "policy outcome", translation: "résultat de politique", example: "Policy outcomes differed significantly from initial projections." },
    ...
    { word: "public administration", translation: "administration publique", example: "Public administration involves managing government operations and programs." },
    { word: "civil service", translation: "fonction publique", example: "Civil service reforms aimed to professionalize government employment." },
    ...
    { word: "administrative law", translation: "droit administratif", example: "Administrative law defines the powers and constraints of executive agencies." },
    { word: "regulatory agency", translation: "agence de réglementation", example: "The regulatory agency issued new standards for workplace safety." },
    ...
    { word: "organizational structure", translation: "structure organisationnelle", example: "The department's organizational structure divides responsibilities by function." },
    ...
    { word: "administrative state", translation: "état administratif", example: "The growth of the administrative state expanded the role of expert agencies." },
    ...
    { word: "multilevel governance", translation: "gouvernance à multiniveaux", example: "Climate policy requires multilevel governance from local to global scales." },
    ...
    { word: "policy coordination", translation: "coordination des politiques", example: "Fragmented governance systems complicate policy coordination across levels." },
    { word: "vertical integration", translation: "intégration verticale", example: "The program achieved vertical integration from federal funding to local implementation." },
    ...
    { word: "supranational governance", translation: "gouvernance supranationale", example: "The European Union represents a system of supranational governance above nations." },
    ...
    { word: "local government", translation: "gouvernement local", example: "Local government responsibilities include zoning, infrastructure, and public safety." },
    ...
    { word: "jurisdictional overlap", translation: "chevauchement juridictionnel", example: "Jurisdictional overlap between agencies creates coordination challenges." },
    ...
    { word: "governance structure", translation: "structure de gouvernance", example: "The governance structure defines decision-making authorities and accountabilities." },
    ...
    { word: "policy analysis", translation: "analyse des politiques", example: "Policy analysis evaluates alternatives based on projected outcomes and tradeoffs." },
    { word: "evidence-based policy", translation: "politique fondée sur des preuves", example: "Evidence-based policy uses research findings to inform decision-making." },
    { word: "policy instrument", translation: "instrument politique", example: "Taxation is a policy instrument to influence behavior and raise revenue." },
    ...
    { word: "distributional impact", translation: "impact distributif", example: "Analysis examined the distributional impact of tax proposals across income groups." },
    ...
    { word: "risk assessment", translation: "évaluation des risques", example: "The risk assessment identified potential unintended consequences of the proposal." },
    ...
    { word: "structural adjustment", translation: "ajustement structurel", example: "The loan package required structural adjustment policies including privatization." },
    ...
    { word: "governance reform", translation: "réforme de la gouvernance", example: "Governance reform introduced transparency requirements and ethical standards." },
    ...
    { word: "change management", translation: "gestion du changement", example: "Effective change management strategies helped navigate organizational transitions." },
    ...
    { word: "structural transformation", translation: "transformation structurelle", example: "Economic development requires structural transformation of productive sectors." },
