export const vocab = {
  ...
  words: [
    ...
    { word: "virtual reality headset", translation: "casque de réalité virtuelle", example: "The virtual reality headset creates an immersive experience." },
    { word: "smart speaker", translation: "enceinte intelligente", example: "You can ask your smart speaker to play music or answer questions." },
    { word: "wearable technology", translation: "technologie portable", example: "Wearable technology includes fitness trackers and smart glasses." },
    { word: "digital camera", translation: "appareil photo numérique", example: "Professional photographers still prefer digital cameras over smartphones." },
    { word: "drone", translation: "drone", example: "They used a drone to capture aerial footage." },
    { word: "wireless earbuds", translation: "écouteurs sans fil", example: "Wireless earbuds are convenient for exercising." },
    { word: "charging dock", translation: "station de charge", example: "Keep your devices on the charging dock overnight." },
    { word: "fingerprint scanner", translation: "lecteur d'empreintes digitales", example: "Most smartphones now include a fingerprint scanner for security." },
    { word: "portable hard drive", translation: "disque dur portable", example: "Back up your important files on a portable hard drive." },
    { word: "smart home device", translation: "appareil domotique", example: "Smart home devices allow you to control lighting and temperature remotely." },
    ...
    { word: "server", translation: "serveur", example: "The company's data is stored on secure servers." },
    { word: "firewall", translation: "pare-feu", example: "A firewall helps protect your network from unauthorized access." },
    { word: "VPN", translation: "RPV (réseau privé virtuel)", example: "Use a VPN to protect your privacy when using public Wi-Fi." },
    { word: "cloud storage", translation: "stockage en nuage", example: "Cloud storage lets you access your files from any device." },
    { word: "data plan", translation: "forfait de données", example: "Check how much data is included in your mobile data plan." },
    { word: "hotspot", translation: "point d'accès", example: "You can use your phone as a hotspot to connect your laptop to the internet." },
    ...
    { word: "bug", translation: "bogue", example: "The developers are working to fix a bug in the latest version." },
    { word: "download", translation: "télécharger", example: "You can download the app from the App Store." },
    { word: "install", translation: "installer", example: "Follow these instructions to install the software." },
    { word: "user account", translation: "compte utilisateur", example: "Create a user account to save your preferences." },
    { word: "password manager", translation: "gestionnaire de mots de passe", example: "A password manager helps you create and store secure passwords." },
    { word: "productivity tools", translation: "outils de productivité", example: "Microsoft Office includes several productivity tools." },
    { word: "antivirus", translation: "antivirus", example: "Make sure your antivirus software is up to date." },
    { word: "browser", translation: "navigateur", example: "Chrome and Firefox are popular web browsers." },
    { word: "plugin", translation: "extension", example: "This plugin adds new features to the software." },
    { word: "in-app purchase", translation: "achat intégré", example: "Many free apps generate revenue through in-app purchases." },
    ...
    { word: "virtual reality", translation: "réalité virtuelle", example: "Virtual reality creates immersive simulated environments." },
    { word: "biotechnology", translation: "biotechnologie", example: "Advances in biotechnology are improving medical treatments." },
    { word: "nanotechnology", translation: "nanotechnologie", example: "Nanotechnology involves manipulating matter at the atomic scale." },
    { word: "3D printing", translation: "impression 3D", example: "3D printing allows for rapid prototyping of physical objects." },
    { word: "autonomous vehicle", translation: "véhicule autonome", example: "Autonomous vehicles use sensors and AI to navigate without human input." },
    { word: "robotics", translation: "robotique", example: "Robotics is increasingly important in manufacturing." },
    { word: "quantum computing", translation: "informatique quantique", example: "Quantum computing has the potential to solve complex problems much faster." },
    { word: "biometric authentication", translation: "authentification biométrique", example: "Biometric authentication includes fingerprint and facial recognition." },
    { word: "renewable energy technology", translation: "technologie d'énergie renouvelable", example: "Solar panels are an example of renewable energy technology." },
    ...
    { word: "cybersecurity threat", translation: "menace de cybersécurité", example: "Phishing is a common cybersecurity threat." },
    { word: "data breach", translation: "violation de données", example: "The company experienced a data breach affecting millions of users." },
    { word: "system crash", translation: "plantage système", example: "Remember to save your work frequently in case of a system crash." },
    { word: "compatibility issue", translation: "problème de compatibilité", example: "The app has compatibility issues with older devices." },
    { word: "software vulnerability", translation: "vulnérabilité logicielle", example: "Hackers exploit software vulnerabilities to gain unauthorized access." },
    { word: "bandwidth limitation", translation: "limitation de bande passante", example: "Bandwidth limitations can cause video streaming to buffer." },
    { word: "hardware failure", translation: "défaillance matérielle", example: "Data loss can result from hardware failure." },
    { word: "overheating", translation: "surchauffe", example: "Overheating can damage electronic components." },
    { word: "troubleshooting", translation: "dépannage", example: "The IT department provided troubleshooting steps for common problems." },
    { word: "network congestion", translation: "congestion réseau", example: "Network congestion slows down internet speeds during peak usage times." },
    ...
    { word: "digital detox", translation: "désintoxication numérique", example: "Taking a digital detox involves temporarily disconnecting from electronic devices." },
    { word: "technological determinism", translation: "déterminisme technologique", example: "Technological determinism suggests that technology shapes society more than society shapes technology." },
    { word: "digital wellbeing", translation: "bien-être numérique", example: "Apps that promote digital wellbeing help users develop healthier technology habits." },
    { word: "algorithmic bias", translation: "biais algorithmique", example: "Researchers are working to identify and eliminate algorithmic bias." },
    { word: "digital sovereignty", translation: "souveraineté numérique", example: "Many countries are concerned about maintaining digital sovereignty." },
