...
const Input = forwardRef(({
  ...
  const labelAnim = useRef(new Animated.Value(
      ...
      >
        ...
        <TextInput
          ...
          style={[
            ...
            (rightIcon || showClearButton || showPasswordToggle) && styles.inputWithRightIcon,
            inputStyle,
          ]}
          value={value !== undefined ? value : internalValue}
          onChangeText={handleChangeText}
          placeholder={!floatingLabel || isFocused || (value || internalValue) ? placeholder : ''}
