...
const ResultsScreen = ({
  ...
  const successPercentage = Math.round((correctAnswers / totalQuestions) * 100) || 0;
              ...
              <View key={index} style={styles.detailedResultItem}>
                ...
                <View style={styles.answersContainer}>
                  <View style={styles.answerRow}>
                    ...
                    <Text style={[
                      styles.answerValue,
                      result.isCorrect ? styles.correctAnswer : 
                      result.isSkipped ? styles.skippedAnswer : styles.incorrectAnswer
                    ]}>
